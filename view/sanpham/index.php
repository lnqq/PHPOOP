...
<nav class="navbar navbar-default navbar-static-top">
  ...
  <div >
      ...
      ?>
      <div class="card" style="width: 38rem;float: left;">
        <div class=" col-md-12" style="float: left;">
          <div class="thumbnail">
            <img class="card-img-top" src="img/<?php echo $value['img']; ?>" alt="Card image cap" style="height:200px" >
            <div class="caption">
              ...
              <a class="btn btn-success" href="?chitiet_sanpham=<?php echo $value['id']; ?>">
               Sửa
             </a>
             <a class="btn btn-danger" href="?xoa_sanpham=<?php echo $value['id']; ?>">
              Xóa
            </a>
          </div>
        </div>
