...
<nav class="navbar navbar-default navbar-static-top">
  ...
  <!-- <h3 style="text-align:center; ">DANH SACH LOAI SAN PHAM</h3> -->
  <table class="table col-md-10 table-bordered" style="text-align: center;" >
    <thead>
      <tr>
    ...
    <tbody >
      ...
      ?>
        <tr >
          <th scope="row"><?php echo $value['id_loaisp']; ?></th>
          <td><?php echo $value['tenloaisanpham']; ?></td>
          <td>
            <a href="?chitiet_loaisanpham=<?php echo $value['id_loaisp']; ?>">
             <button type="submit" class="btn btn-btn btn-success">Sửa</button>
            </a>
            <a href="?xoa_loaisanpham=<?php echo $value['id_loaisp']; ?>">
