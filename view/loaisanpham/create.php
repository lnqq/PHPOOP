...
<nav class="navbar navbar-default navbar-static-top">
  ...
  <div class="card mt-2 col-10">
    ...
    <div class="card-body">
      <form class=" mt-5 mr-10" method="post">
        <div class="form-group row">
          <label  class="col-sm-2 col-form-label">Tên loại sản phẩm:</label>
          <div class="col-sm-6">
            <input type="text" name="tenloaisanpham" class="form-control" >
          </div>

        </div>
        <div class="form-group row" style="margin-left: 15.5%">
          <div class="col-sm-10">
            <button type="submit" class="btn btn-outline-danger" name="luu_loaisanpham">Lưu Thông Tin</button>
            <a href="?danhsach_loaisanpham" class="btn btn-outline-danger">Danh sách loại sản phẩm</a
          </div>
        </div>
      </form>
    </div>
